                        ...
                        <div class="text-center">
                            ...
                            <form action="upload_image_script.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="exampleInputImage1" aria-describedby="imageHelp" name="image_upload">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputLatitude1" aria-describedby="latitudeHelp" placeholder="Enter Latitude" name="image_latitude">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="exampleInputLongitude1">Longitude</label>
                                    <input type="text" class="form-control" id="exampleInputLongitude1" aria-describedby="longitudeHelp" placeholder="Enter Longitude" name="image_longitude">
                                </div>
