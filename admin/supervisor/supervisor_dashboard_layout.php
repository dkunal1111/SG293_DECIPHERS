    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a href="supervisor_profile.php"><i class="fa fa-fw fa-user"></i> Profile</a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-fw fa-envelope"></i> Inbox</a>
                </li>
                <li>
                    <a href="supervisor_settings.php"><i class="fa fa-fw fa-gear"></i> Settings</a>
                </li>
                <li class="divider"></li>
                <li>
        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="project" class="collapse">
                    ...
                    <li>
                        <a href="update_project_status.php"><i class="fa fa-fw fa-table"></i>Update Project</a>
                    </li>
            ...
            <li>
                <a href="map.php"><i class="fa fa-fw fa-bar-chart-o"></i> Chart</a>
            </li>
